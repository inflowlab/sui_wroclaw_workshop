module patterns_best_practices::capability_tests {
    ...
    public fun can_mint_with_cap() {
        ...
        let cap = capability::new_admin_for_test(test_scenario::ctx(&mut sc));
        capability::mint_badge(&cap, string::utf8(b"VIP"), 1, ADMIN, test_scenario::ctx(&mut sc));
        capability::destruct_for_test(cap);
